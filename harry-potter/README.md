# Harry Potter Student Portal

Create an account, view courses, staff, spells, potions, and shop online at Hogsmeade.

## Getting Started
Start by running potter.sql to build and seed the database.
